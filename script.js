...
class App extends React.Component {
  ...
  handleClick(e) {
    ...
    if (e == "=") {//when clicking =
      this.handleEquals(e, data, expression, flagEquals, flagOperator, negativeNumber, flagDecimals);
    }
    if (e == ".") {
  ...
  handleEquals(e, data, expression, flagEquals, flagOperator, negativeNumber, flagDecimals) {//RETURNING UNDEFINED AFTER 9/- -> press * and then =
    ...
    //let rounded=Math.round(1000000000000 * result)/ 1000000000000;//more precision
    let rounded = parseFloat(result.toFixed(16)); //round a number
    //rounded=Math.round(1000000000000 * rounded)/ 1000000000000;
  ...
  render() {
    ...
    const buttons = calculatorButtons.map(button => React.createElement("button", { key: button.id, id: button.id, className: button.class, onClick: e => this.handleClick(button.obj) }, button.label));
    return (
      React.createElement("div", { id: "parent" },
      React.createElement("div", { id: "calculator" },
      React.createElement("div", { id: "display-parent" },
      React.createElement("div", { id: "upper-display" }, React.createElement("h5", null, this.state.upperDisplay)),

      React.createElement("div", { id: "display" }, React.createElement("p", null, this.state.display))),
